...
const LINE2 = [
  '신도림', '성수', '신설동', '용두', '신답', '용답', '시청', '충정로', '아현', '이대', 
  '신촌', '공항철도', '홍대입구', '합정', '당산', '영등포구청', '문래', '대림', '구로디지털단지', '신대방', 
  '신림', '봉천', '서울대입구', '낙성대', '사당', '방배', '서초', '교대', '강남', '역삼', 
  '선릉', '삼성', '종합운동장', '신천', '잠실', '잠실나루', '강변', '구의', '건대입구', '뚝섬', 
...
class Subway{
    ...
    *[Symbol.iterator](){ // generator
        ...
        while(1){
            const nowStn = LINE2[this.#currIdx++];
    ...
    toString(){
        // 1. #currIdx 로 수정
// 2. 문구와 띄어쓰기, 콤마(,)를 테스트 코드 기대값과 100% 일치시킴
