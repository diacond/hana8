...
public class MemberController {
  ...
  @PostMapping(value = "/files/upload", consumers = MediaType.MULTIPART_FORM_DATA_VALUE)
  ...
  @PutMapping("/{id}")
  MemberDTO editMember(@PathVariable Long id,
      @Validated(MemberDTO.OnUpdate.class) @RequestBody MemberDTO member) {
    member.setId(id);
